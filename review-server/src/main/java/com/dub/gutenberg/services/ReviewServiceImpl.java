...
/** 
 * everything has to be cleaned later, restore the original names 
 * don't use any private method to keep things legible
 * */
...
public class ReviewServiceImpl implements ReviewService{
	...
	@Override
	public Mono<String> createReview(Review review) throws IOException {
	    ...
	    return Mono.just(response.getId());	
	}

	@Override
	public Mono<Review> getReviewById(String reviewId) throws IOException {
		
		return Mono.just(this.doGetReviewById(reviewId));	
	}

	@Override
	public Flux<Review> getReviewsByUserId(String userId) throws IOException {
		...
		return Flux.fromIterable(doGetReviewList(response));
	}
