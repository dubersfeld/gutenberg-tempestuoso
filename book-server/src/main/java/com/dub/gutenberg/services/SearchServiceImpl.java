...
public class SearchServiceImpl implements SearchService {
	...
	//@Override
	private List<Book> searchByTitle(String searchString) throws IOException {
	...
	//@Override
	private List<Book> searchByDescription(String searchString) throws IOException {
	...
	//@Override
	private List<Book> searchByTags(String searchString) throws IOException {
	...
	public Flux<Book> fluxSearchByDescription(String searchString) throws IOException {
		...
		return Flux.fromIterable(this.searchByDescription(searchString));
	}

	@Override
	public Flux<Book> fluxSearchByTags(String searchString) throws IOException {
		return Flux.fromIterable(this.searchByTags(searchString));
	}

	@Override
	public Flux<Book> fluxSearchByTitle(String searchString) throws IOException {
		//throw new IOException();
		return Flux.fromIterable(this.searchByTitle(searchString));
	} 
