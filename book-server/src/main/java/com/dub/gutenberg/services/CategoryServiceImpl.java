...
public class CategoryServiceImpl implements CategoryService {
	...
	//@Override
	private Category getCategory(String categorySlug) throws IOException {
	...
	public Flux<Category> fluxAllCategories() throws IOException {
		...
		List<Category> cats = this.getAllCategories();
		
		return Flux.fromIterable(cats);
	...
	public Mono<Category> monoCategory(String categorySlug) throws IOException {
		return Mono.just(this.getCategory(categorySlug));
	}
}