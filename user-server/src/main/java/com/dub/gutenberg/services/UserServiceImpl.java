...
public class UserServiceImpl implements UserService {
	...
	@Override
	public Mono<MyUser> monoFindByUsername(String username) throws IOException {
		...
		//return Mono.justOrEmpty(this.findByUsername(username));
	}

	@Override
	public Mono<MyUser> monoFindById(String userId) throws IOException {
		// should never be null
		return Mono.just(this.findById(userId));
	}

	@Override
	public Mono<MyUser> monoDeletePaymentMethod(String userId, PaymentMethod payMeth) throws IOException {
		// TODO Auto-generated method stub
		return Mono.just(this.deletePaymentMethod(userId, payMeth));
	}

	@Override
	public Mono<MyUser> monoDeleteAddress(String userId, Address delAddress) throws IOException {
		// TODO Auto-generated method stub
		return Mono.just(this.deleteAddress(userId, delAddress));
	}

	@Override
	public Mono<MyUser> monoAddPaymentMethod(String userId, PaymentMethod newPayment) throws IOException {
		
		return Mono.just(this.addPaymentMethod(userId, newPayment));
	}

	@Override
	public Mono<MyUser> monoAddAddress(String userId, Address newAddress) throws IOException {
		// TODO Auto-generated method stub
		return Mono.just(this.addAddress(userId, newAddress));
	}

	@Override
	public Mono<MyUser> monoSetPrimaryPayment(String userId, int index) throws IOException {
		// TODO Auto-generated method stub
		return Mono.just(this.setPrimaryPayment(userId, index));
	}

	@Override
	public Mono<MyUser> monoSetPrimaryAddress(String userId, int index) throws IOException {
		// TODO Auto-generated method stub
		return Mono.just(this.setPrimaryAddress(userId, index));
	}

	@Override
	public Mono<String> monoCreateUser(MyUser user) throws IOException {
		// TODO Auto-generated method stub
		return Mono.just(this.createUser(user));
	}
