...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public Mono<Order> saveOrder(Order order, boolean creation) throws IOException {
	...
	@Override
	public Mono<Order> getOrderById(String orderId) throws IOException {
	...
	public Mono<Order> getActiveOrder(String userId) throws IOException {
		...
		if (totalHits == 1) {
			...
			System.out.println("Service returns OK");
			return Mono.just(order);	
		} else {
			System.out.println("Service throws OrderNotFoundException");
			throw new OrderNotFoundException();
		}
	}
	...
	public Mono<Order> setOrderState(String orderId, OrderState state) throws IOException {
		...
		// update Order ES document
		return Mono.just(orderRepo.doUpdateOrder(oldOrder));
	}
	...
	public Mono<Order> checkoutOrder(String orderId) throws IOException {
		...
		return Mono.just(orderRepo.doUpdateOrder(order));
	}
